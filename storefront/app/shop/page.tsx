      ...
      <FilterSection title="Fabric">
        {FABRICS.map(fabric => (
          <label key={fabric} className="flex items-center gap-2 mb-2 cursor-pointer">
            ...
            <span className="text-sm" style={{ color: 'var(--color-text-secondary)', fontFamily: 'var(--font-body)' }}>{fabric}</span>
          </label>
        ))}
      </FilterSection>
        ...
        {OCCASIONS.map(occ => (
          <label key={occ} className="flex items-center gap-2 mb-2 cursor-pointer">
            <input type="checkbox" checked={selectedOccasions.includes(occ)}
              ...
              style={{ accentColor: 'var(--color-accent)' }} />
            <span className="text-sm" style={{ color: 'var(--color-text-secondary)', fontFamily: 'var(--font-body)' }}>{occ}</span>
          </label>
        ))}
      </FilterSection>
      ...
      <div className="page-container py-8">
        ...
        <div className="flex items-end justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="flex items-center gap-2 px-4 py-2 border text-xs uppercase tracking-widest md:hidden"
            ...
            <select value={sortBy} onChange={e => setSortBy(e.target.value)}
              ...
              style={{ borderColor: 'var(--color-border)', fontFamily: 'var(--font-body)', color: 'var(--color-text-primary)' }}>
      ...
      <AnimatePresence>
        {filtersOpen && (
          <>
            ...
            <motion.div
              className="fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl p-6 overflow-y-auto"
